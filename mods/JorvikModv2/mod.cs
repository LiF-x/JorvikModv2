...
package JorvikMod2
{
  ...
  function JorvikMod2::SmallWoodenShed() {
    ...
    dbi.Select(JorvikMod2, "SmallWoodenShedRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Shed', 'Object from Jorvik MOD',        32,               18,          60,        2403,               25,           1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_shed.png') RETURNING ID");
  }
  ...
  function JorvikMod2::FlagPvP() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,       Quantity, Autorepeat, isBluePrint, ImagePath)
    dbi.Select(JorvikMod2, "FlagPvPRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Flag PvP', 'Object from Jorvik MOD',        32,               19,          100,        2452,               20,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/flag_pvp.png') RETURNING ID");
  }
  ...
  function JorvikMod2::FlagPvE() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,       Quantity, Autorepeat, isBluePrint, ImagePath)
    dbi.Select(JorvikMod2, "FlagPvERequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Flag PvE', 'Object from Jorvik MOD',        32,               19,          100,        2453,               20,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/flag_pvp.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Longhouse() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,       Quantity, Autorepeat, isBluePrint, ImagePath)
    dbi.Select(JorvikMod2, "LonghouseRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Longhouse', 'Object from Jorvik MOD',        32,               20,          60,        2543,               20,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/long_house.png') RETURNING ID");
  }
  ...
  function JorvikMod2::StoneGate() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,       Quantity, Autorepeat, isBluePrint, ImagePath)
    dbi.Select(JorvikMod2, "StoneGateRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Stone Gate', 'Object from Jorvik MOD',        32,               19,          60,        2554,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/stone_gate.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenBridge() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,                  Quantity,Autorepeat,isBluePrint,           ImagePath)
    dbi.Select(JorvikMod2, "SmallWoodenBridgeRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Bridge', 'Object from Jorvik MOD',        32,               18,          60,        2455,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_bridge.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallStoneBridge() {
                                   //dbi.update("INSERT IGNORE INTO `recipe` VALUES (NULL,      Name,                 Description,      StartingToolsID,   SkillTypeID, SkillLvl, ResultObjectTypeID, SkillDepends,                  Quantity,Autorepeat,isBluePrint,           ImagePath)
    dbi.Select(JorvikMod2, "SmallStoneBridgeRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Stone Gate', 'Object from Jorvik MOD',        32,               18,          60,        2456,               35,                       0,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_bridge.png') RETURNING ID");
  }
  ...
  function JorvikMod2::LargeWoodenBridge() {
    dbi.Select(JorvikMod2, "LargeWoodenBridgeRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Large Wooden Bridge', 'Object from Jorvik MOD',        32,               18,          60,        2457,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/large_wooden_bridge.png') RETURNING ID");
  }
  function JorvikMod2::LargeWoodenBridgeRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "LargeStoneBridgeRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Large Stone Bridge', 'Object from Jorvik MOD',        32,               19,          60,        2458,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/large_stone_bridge.png') RETURNING ID");
  }
  function JorvikMod2::LargeStoneBridgeRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "LargeStoneBridgeEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Large Stone Bridge End', 'Object from Jorvik MOD',        32,               19,          60,        2459,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/large_stone_bridge_end.png') RETURNING ID");
  }
  function JorvikMod2::LargeStoneBridgeEndRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "SmallStoneBridgeEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Stone Bridge End', 'Object from Jorvik MOD',        32,               19,          60,        2460,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_stone_bridge_end.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWall() {
    dbi.Select(JorvikMod2, "SmallLogWallRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall', 'Object from Jorvik MOD',        32,               18,          30,        2561,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenPillar() {
    dbi.Select(JorvikMod2, "SmallWoodenPillarRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Pillar', 'Object from Jorvik MOD',        32,               18,          30,        2562,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_pillar.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogCornerWall() {
    dbi.Select(JorvikMod2, "SmallLogCornerWallRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Corner Wall', 'Object from Jorvik MOD',        32,               18,          30,        2563,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_corner_wall.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithWindow() {
    dbi.Select(JorvikMod2, "SmallLogWallWithWindowRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Window', 'Object from Jorvik MOD',        32,               18,          30,        2564,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_window.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithShutters() {
    dbi.Select(JorvikMod2, "SmallLogWallWithShuttersRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Shutters', 'Object from Jorvik MOD',        32,               18,          30,        2565,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_shutters.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithEntrance() {
    dbi.Select(JorvikMod2, "SmallLogWallWithEntranceRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Entrance', 'Object from Jorvik MOD',        32,               18,          30,        2566,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_entrance.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithDoor() {
    dbi.Select(JorvikMod2, "SmallLogWallWithDoorRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Door', 'Object from Jorvik MOD',        32,               18,          30,        2567,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_door.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenFloorEntrance() {
    dbi.Select(JorvikMod2, "SmallWoodenFloorEntranceRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Floor Entrance', 'Object from Jorvik MOD',        32,               18,          30,        2568,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_floor_entrance.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenFloor() {
    dbi.Select(JorvikMod2, "SmallWoodenFloorRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Floor', 'Object from Jorvik MOD',        32,               18,          30,        2569,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_floor.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallSlopeRight() {
    dbi.Select(JorvikMod2, "SmallLogWallSlopeRightRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall Slope Right', 'Object from Jorvik MOD',        32,               18,          30,        2474,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_slope_right.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallSlopeLeft() {
    dbi.Select(JorvikMod2, "SmallLogWallSlopeLeftRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall Slope Left', 'Object from Jorvik MOD',        32,               18,          30,        2475,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_slope_left.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoof() {
    dbi.Select(JorvikMod2, "SmallThatchRoofRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoof', 'Object from Jorvik MOD',        32,               18,          30,        2476,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofRightEnd() {
    dbi.Select(JorvikMod2, "SmallThatchRoofRightEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofRightEnd', 'Object from Jorvik MOD',        32,               18,          30,        2477,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_right_end.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofLeftEnd() {
    dbi.Select(JorvikMod2, "SmallThatchRoofLeftEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofLeftEnd', 'Object from Jorvik MOD',        32,               18,          30,        2478,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_left_end.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofOuterCorner() {
    dbi.Select(JorvikMod2, "SmallThatchRoofOuterCornerRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofOuterCorner', 'Object from Jorvik MOD',        32,               18,          30,        2479,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_outer_corner.png') RETURNING ID");
  }
  function JorvikMod2::SmallThatchRoofOuterCornerRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "SmallLogWalllvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall', 'Object from Jorvik MOD',        32,               18,          30,        2481,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenPillarlvl1() {
    dbi.Select(JorvikMod2, "SmallWoodenPillarlvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Pillar', 'Object from Jorvik MOD',        32,               18,          30,        2482,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_pillar_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogCornerWalllvl1() {
    dbi.Select(JorvikMod2, "SmallLogCornerWallRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Corner Wall', 'Object from Jorvik MOD',        32,               18,          30,        2483,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_corner_wall_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithWindowlvl1() {
    dbi.Select(JorvikMod2, "SmallLogWallWithWindowlvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Window', 'Object from Jorvik MOD',        32,               18,          30,        2484,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_window_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithShutterslvl1() {
    dbi.Select(JorvikMod2, "SmallLogWallWithShutterslvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Shutters', 'Object from Jorvik MOD',        32,               18,          30,        2544,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_shutters_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithEntrancelvl1() {
    dbi.Select(JorvikMod2, "SmallLogWallWithEntrancelvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Entrance', 'Object from Jorvik MOD',        32,               18,          30,        2545,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_entrance_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallLogWallWithDoorlvl1() {
    dbi.Select(JorvikMod2, "SmallLogWallWithDoorlvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Log Wall With Door', 'Object from Jorvik MOD',        32,               18,          30,        2546,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_log_wall_with_door_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenFloorEntrancelvl1() {
    dbi.Select(JorvikMod2, "SmallWoodenFloorEntranceRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Floor Entrance', 'Object from Jorvik MOD',        32,               18,          30,        2547,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_floor_entrance_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenFloorlvl1() {
    dbi.Select(JorvikMod2, "SmallWoodenFloorlvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Floor', 'Object from Jorvik MOD',        32,               18,          30,        2548,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_floor_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenStairs() {
    dbi.Select(JorvikMod2, "SmallWoodenStairsRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Stairs', 'Object from Jorvik MOD',        32,               18,          30,        2549,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_stairs.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofTop() {
    dbi.Select(JorvikMod2, "SmallThatchRoofTopRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofTop', 'Object from Jorvik MOD',        32,               18,          30,        2550,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_top.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofOuterCornerTop() {
    dbi.Select(JorvikMod2, "SmallThatchRoofOuterCornerTopRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofOuterCornerTop', 'Object from Jorvik MOD',        32,               18,          30,        2551,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_outer_corner_top.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofTopLeftEnd() {
    dbi.Select(JorvikMod2, "SmallThatchRoofTopLeftEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofTopLeftEnd', 'Object from Jorvik MOD',        32,               18,          30,        2493,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_top_left_end.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofTopRightEnd() {
    dbi.Select(JorvikMod2, "SmallThatchRoofTopRightEndRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofTopRightEnd', 'Object from Jorvik MOD',        32,               18,          30,        2494,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_top_right_end.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRooflvl1() {
    dbi.Select(JorvikMod2, "SmallThatchRooflvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoof', 'Object from Jorvik MOD',        32,               18,          30,        2495,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofOuterCornerlvl1() {
    dbi.Select(JorvikMod2, "SmallThatchRoofOuterCornerlvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofOuterCorner', 'Object from Jorvik MOD',        32,               18,          30,        2496,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_outer_corner.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenRailing() {
    dbi.Select(JorvikMod2, "SmallWoodenRailingRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Railing', 'Object from Jorvik MOD',        32,               18,          30,        2497,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_railing.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenRailinglvl1() {
    dbi.Select(JorvikMod2, "SmallWoodenRailinglvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Railing', 'Object from Jorvik MOD',        32,               18,          30,        2498,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_railing_lvl1.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofOuterCornerToplvl1() {
    dbi.Select(JorvikMod2, "SmallThatchRoofOuterCornerToplvl1Requirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoofOuterCornerTop', 'Object from Jorvik MOD',        32,               18,          30,        2499,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_outer_corner_top.png') RETURNING ID");
  }
  ...
  function JorvikMod2::WallTorch() {
    dbi.Select(JorvikMod2, "WallTorchRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wall Torch', 'Object from Jorvik MOD',        0,               62,          0,        2500,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wall_torch.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallCandle() {
    dbi.Select(JorvikMod2, "SmallCandleRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Candle', 'Object from Jorvik MOD',        0,               62,          0,        2502 ,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_candle.png') RETURNING ID");
  }
  ...
  function JorvikMod2::AurochsCowstand() {
    dbi.Select(JorvikMod2, "AurochsCowstandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Cow (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2504,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_cow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::AurochsCoweat() {
    dbi.Select(JorvikMod2, "AurochsCoweatRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Cow (eat)', 'Object from Jorvik MOD',        2517,                14,          90,        2505,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_cow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Aurochssleep() {
    dbi.Select(JorvikMod2, "AurochsCowsleepRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Cow (sleep)', 'Object from Jorvik MOD',        2517,                14,          90,        2506,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_cow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Sowstand() {
    dbi.Select(JorvikMod2, "SowstandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Sow (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2508,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/sow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Soweat() {
    dbi.Select(JorvikMod2, "SoweatRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Sow (eat)', 'Object from Jorvik MOD',        2517,                14,          90,        2509,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/sow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Sowsleep() {
    dbi.Select(JorvikMod2, "SowsleepRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Sow (sleep)', 'Object from Jorvik MOD',        2517,                14,          90,        2510,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/sow.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Horsestand() {
    dbi.Select(JorvikMod2, "HorsestandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Horse (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2510,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/horse.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Horseeat() {
    dbi.Select(JorvikMod2, "HorseeatRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Horse (eat)', 'Object from Jorvik MOD',        2517,                14,          90,        2512,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/horse.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Horsesleep() {
    dbi.Select(JorvikMod2, "HorsesleepRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Horse (sleep)', 'Object from Jorvik MOD',        2517,                14,          90,        2513,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/horse.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Slaveworking() {
    dbi.Select(JorvikMod2, "SlaveworkingRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Slave (working)', 'Object from Jorvik MOD',        2517,                14,          90,        2514,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/slave.png') RETURNING ID");
  }
  ...
  function JorvikMod2::WranentheHunterstand() {
    dbi.Select(JorvikMod2, "WranentheHunterstandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wranen the Hunter (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2515,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wranen_the_hunter.png') RETURNING ID");
  }
  ...
  function JorvikMod2::BookPaper() {
    dbi.Select(JorvikMod2, "BookPaperRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Book Paper', 'Object from Jorvik MOD',        293,               8,          90,        2516,               10,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/paper.png') RETURNING ID");
  }
  ...
  function JorvikMod2::HealthBook() {
    dbi.Select(JorvikMod2, "HealthBookRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Health Book', 'Object from Jorvik MOD',        293,               8,          90,        2517,               10,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/health_book.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallThatchRoofInnerCorner() {
    dbi.Select(JorvikMod2, "SmallThatchRoofInnerCornerRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'SmallThatchRoof Inner Corner', 'Object from Jorvik MOD',        32,               18,          30,        2518,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_thatch_roof_inner_corner.png') RETURNING ID");
  }
  function JorvikMod2::SmallThatchRoofInnerCornerRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "WoodCartRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wood Cart', 'Object from Jorvik MOD',        36,               8,          90,        2519,               30,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wood_cart.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SiegeTower() {
    dbi.Select(JorvikMod2, "SiegeTowerRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Siege Tower', 'Object from Jorvik MOD',        36,               10,          0,        2520,               30,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/siegetower.png') RETURNING ID");
  }
  ...
  function JorvikMod2::AurochsBullstand() {
    dbi.Select(JorvikMod2, "AurochsBullstandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Bull (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2521,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_bull.png') RETURNING ID");
  }
  ...
  function JorvikMod2::AurochsBulleat() {
    dbi.Select(JorvikMod2, "AurochsBulleatRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Bull (eat)', 'Object from Jorvik MOD',        2517,                14,          90,        2522,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_bull.png') RETURNING ID");
  }
  ...
  function JorvikMod2::AurochsBullsleep() {
    dbi.Select(JorvikMod2, "AurochsBullsleepRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Aurochs Bull (sleep)', 'Object from Jorvik MOD',        2517,                14,          90,        2523,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/aurochs_bull.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenPier() {
    dbi.Select(JorvikMod2, "SmallWoodenPierRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Pier', 'Object from Jorvik MOD',        32,               18,          60,        2524,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_pier.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenPierT() {
    dbi.Select(JorvikMod2, "SmallWoodenPierTRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Pier T', 'Object from Jorvik MOD',        32,               18,          60,        2525,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_pier_T.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SmallWoodenPierL() {
    dbi.Select(JorvikMod2, "SmallWoodenPierLRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Small Wooden Pier L', 'Object from Jorvik MOD',        32,               18,          60,        2526,               10,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/small_wooden_pier_L.png') RETURNING ID");
  }
  ...
  function JorvikMod2::WattleWicket() {
    dbi.Select(JorvikMod2, "WattleWicketRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wattle Wicket', 'Object from Jorvik MOD',        32,               18,          0,        2527,               30,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wattle_wicket.png') RETURNING ID");
  }
  ...
  function JorvikMod2::IdolCross() {
    dbi.Select(JorvikMod2, "IdolCrossRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Idol Cross', 'Object from Jorvik MOD',        34,               54,          0,        2528,               25,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/idol_cross.png') RETURNING ID");
  }
  ...
  function JorvikMod2::WoodenChurch() {
    dbi.Select(JorvikMod2, "WoodenChurchRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wooden Church', 'Object from Jorvik MOD',        32,               20,          60,        2529,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wooden_church.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SanctumoftheSleeper() {
    dbi.Select(JorvikMod2, "SanctumoftheSleeperRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Sanctum of the Sleeper', 'Object from Jorvik MOD',        32,               20,          60,        2485,               35,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/church.png') RETURNING ID");
  }
  ...
  function JorvikMod2::NoviceDecoratorsKit() {
    dbi.Select(JorvikMod2, "NoviceDecoratorsKitRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Novice Decorator/'s Kit', 'Object from Jorvik MOD',        293,               8,          90,        2531,               10,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/decoration_kit_small.png') RETURNING ID");
  }
  function JorvikMod2::NoviceDecoratorsKitRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "ApprenticeDecoratorsKitRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Apprentice Decorator/'s Kit', 'Object from Jorvik MOD',        293,               8,          90,        2532,               10,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/decoration_kit_medium.png') RETURNING ID");
  }
  function JorvikMod2::ApprenticeDecoratorsKitRequirements(%this, %resultSet) {
    ...
    dbi.Select(JorvikMod2, "MasterDecoratorsKitRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Master Decorator/'s Kit', 'Object from Jorvik MOD',        293,               8,          90,        2533,               10,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/decoration_kit_large.png') RETURNING ID");
  }
  ...
  function JorvikMod2::Wolfstand() {
    dbi.Select(JorvikMod2, "WolfstandRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Wolf (stand)', 'Object from Jorvik MOD',        2517,                14,          90,        2534,               90,                       1,        0,          0,           'yolauncher/modpack/art/2D/Recipes/wolf.png') RETURNING ID");
  }
  ...
  function JorvikMod2::GoldSheet() {
    dbi.Select(JorvikMod2, "GoldSheetRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Gold Sheet', 'Object from Jorvik MOD',        453,               4,          0,        2535,               20,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/gold_sheet.png') RETURNING ID");
  }
  ...
  function JorvikMod2::MetalScissors() {
    dbi.Select(JorvikMod2, "MetalScissorsRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Metal Scissors', 'Object from Jorvik MOD',        453,               4,          0,        2536,               20,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/scissors.png') RETURNING ID");
  }
  ...
  function JorvikMod2::MetalStamp() {
    dbi.Select(JorvikMod2, "MetalStampRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Metal Stamp', 'Object from Jorvik MOD',        453,               4,          0,        2537,               20,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/metal_stamp.png') RETURNING ID");
  }
  ...
  function JorvikMod2::GoldBlanks() {
    dbi.Select(JorvikMod2, "GoldBlanksRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Gold Blanks', 'Object from Jorvik MOD',        453,               4,          90,        2538,               90,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/gold_blanks.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SilverSheet() {
    dbi.Select(JorvikMod2, "Silver SheetRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Silver Sheet', 'Object from Jorvik MOD',        453,               4,          0,        2539,               20,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/silver_sheet.png') RETURNING ID");
  }
  ...
  function JorvikMod2::CopperSheet() {
    dbi.Select(JorvikMod2, "CopperSheetRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Copper Sheet', 'Object from Jorvik MOD',        453,               4,          0,        2540,               20,                       1,        1,          0,           'yolauncher/modpack/art/2D/Items/copper_sheet.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SilverBlanks() {
    dbi.Select(JorvikMod2, "SilverBlanksRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Silver Blanks', 'Object from Jorvik MOD',        453,               4,          90,        2541,               90,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/silver_blanks.png') RETURNING ID");
  }
  ...
  function JorvikMod2::CopperBlanks() {
    dbi.Select(JorvikMod2, "CopperBlanksRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Copper Blanks', 'Object from Jorvik MOD',        453,               4,          90,        2542,               90,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/copper_blanks.png') RETURNING ID");
  }
  ...
  function JorvikMod2::GoldCoins() {
    dbi.Select(JorvikMod2, "GoldCoinsRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Gold Coins', 'Object from Jorvik MOD',        453,               4,          100,        1061,               100,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/gold_coins.png') RETURNING ID");
  }
  ...
  function JorvikMod2::SilverCoins() {
    dbi.Select(JorvikMod2, "SilverCoinsRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Silver Coins', 'Object from Jorvik MOD',        453,               4,          100,        1060,               100,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/silver_coins.png') RETURNING ID");
  }
  ...
  function JorvikMod2::CopperCoins() {
    dbi.Select(JorvikMod2, "CopperCoinsRequirements","INSERT IGNORE INTO `recipe` VALUES (NULL, 'Copper Coins', 'Object from Jorvik MOD',        453,               4,          100,        1059,               100,                       5,        1,          0,           'yolauncher/modpack/art/2D/Items/copper_coins.png') RETURNING ID");
  }
